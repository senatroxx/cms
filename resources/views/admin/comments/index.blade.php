    ...
    <div class="card-body">
        ...
        <table class="table table-hover">
            <tbody>
                ...
                <tr>
                    <td>{{ \Illuminate\Support\Str::limit($com->content, $limit = 60, $end = '...') }} <small> at <a href="{{ route('article.show', $com->post->id) }}" class="text-secondary"><u>{{ $com->post->title }}</u></a></small></td>
