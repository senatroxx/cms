                ...
                <div class="d-flex d-lg-flex d-md-block align-items-center">
                    <div>
                        <div class="d-inline-flex align-items-center">
                            <h2 class="text-dark mb-1 font-weight-medium">{{ $post->count() }}</h2>
        ...
        <div class="card shadow-sm">
            <div class="card-body">
                <div class="d-flex d-lg-flex d-md-block align-items-center">
                    <div>
                        <div class="d-inline-flex align-items-center">
                            <h2 class="text-dark mb-1 font-weight-medium">{{ $comments->count() }}</h2>
                            <h6 class="text-muted font-weight-normal mb-0 w-100 text-truncate ml-2">Comments</h6>
                        </div>
                        <span class="badge badge-success text-white badge-pill d-lg-block d-md-none">{{ $commentsWeek }} New this week</span>
                    </div>
                    <div class="ml-auto mt-md-3 mt-lg-0">
